...
namespace TMG.GDG23
{
    ...
    public partial struct CapabilityCollisionDetectionSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var capabilityHitLookup = SystemAPI.GetBufferLookup<CapabilityHitBufferElement>(false);
    ...
    public struct CapabilityCollisionDetectionJob : ICollisionEventsJob
    {
        ...
        public BufferLookup<CapabilityHitBufferElement> CapabilityHitLookup;
